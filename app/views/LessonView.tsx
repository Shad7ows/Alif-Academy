...
export const LessonView = ({
  ...
  <div className="max-w-3xl mx-auto animate-fade-in-up pb-20">
    ...
    <div className="bg-white dark:bg-slate-800 rounded-4xl p-8 md:p-12 shadow-sm border border-slate-200 dark:border-slate-700">
      ...
      <button
        onClick={onComplete}
        className="w-full bg-slate-900 dark:bg-slate-950 hover:bg-indigo-900 dark:hover:bg-indigo-900 text-white p-5 rounded-2xl text-xl font-bold transition-all shadow-xl shadow-slate-900/20 dark:shadow-slate-950/40 flex items-center justify-center gap-3 hover:-translate-y-1"
      >
